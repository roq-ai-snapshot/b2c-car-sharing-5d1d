  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="B2C Car Sharing - Empowering individual customers to conveniently book nearby cars, managed efficiently by our dedicated operations staff from centralized dashboards."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1515569067071-ec3b51335dd0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYXIlMkJyZW50YWx8ZW58MHx8fHwxNjk4Mjk4NzUzfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@artlasovsky?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Art Lasovsky`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`B2C Car Sharing - Empowering individual customers to conveniently book nearby cars, managed efficiently by our dedicated operations staff from centralized dashboards.`}
            </Text>
            <Box
