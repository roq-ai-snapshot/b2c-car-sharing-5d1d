...
export function CarListPage(props: CarListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['company', 'booking.count', 'operations.count'],
          searchTerm: params.searchTerm,
          searchTermKeys: [
            'make.contains',
            'model.contains',
            'color.contains',
            'license_plate.contains',
            'location.contains',
            'status.contains',
          ],
          ...params.filters,
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('booking', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('operations', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'operations',
          header: 'Operations',
          accessorKey: 'operations',
          cell: ({ row: { original: record } }: any) => record?._count?.operations,
        }
      : null,
