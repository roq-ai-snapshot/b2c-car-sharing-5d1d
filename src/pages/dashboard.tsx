...
import { useRoqPlatformUserProfiles, useCarCount, useBookingCount, useOperationsCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const operationsStat = useOperationsCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Operations',
      result: operationsStat?.data,
      isLoading: operationsStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
