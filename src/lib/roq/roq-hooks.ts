...
export function useOperationsFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useOperationsFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.operations.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useOperationsCount<T extends Prisma.operationsCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.operationsCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useOperationsCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.operations.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useOperationsFindManyWithCount<
  T extends Prisma.operationsFindManyArgs,
  R extends { data: GetFindResult<Prisma.$operationsPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.operationsFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useOperationsFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.operations.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useOperationsFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useOperationsFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.operations.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
