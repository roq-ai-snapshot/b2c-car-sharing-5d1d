...
import type { Prisma, booking, car, company, operations, user } from './types';
...
interface OperationsSDK {
  create: <T extends Prisma.operationsCreateArgs, R extends CheckSelect<T, operations, Prisma.operationsGetPayload<T>>>(
    data: Prisma.SelectSubset<T, Prisma.operationsCreateArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  createMany: <T extends Prisma.operationsCreateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.operationsCreateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  update: <T extends Prisma.operationsUpdateArgs, R extends Prisma.operationsGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.operationsUpdateArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  updateMany: <T extends Prisma.operationsUpdateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.operationsUpdateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  upsert: <T extends Prisma.operationsUpsertArgs, R extends Prisma.operationsGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.operationsUpsertArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  delete: <T extends Prisma.operationsDeleteArgs, R extends Prisma.operationsGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.operationsDeleteArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  deleteMany: <T extends Prisma.operationsDeleteManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.operationsDeleteManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  findMany: <
    T extends Prisma.operationsFindManyArgs,
    R extends GetFindResult<Prisma.$operationsPayload<DefaultArgs>, T>[],
  >(
    args: Prisma.SelectSubset<T, Prisma.operationsFindManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  count: <T extends Prisma.operationsCountArgs, R extends number>(
    args: Prisma.SelectSubset<T, Prisma.operationsCountArgs>,
    options?: RequestOptions,
  ) => Promise<R>;
  ...
  findFirst: <
    T extends Prisma.operationsFindFirstArgs,
    R extends GetFindResult<Prisma.$operationsPayload<DefaultArgs>, T>,
  >(
    args?: Prisma.SelectSubset<T, Prisma.operationsFindFirstArgs>,
    options?: RequestOptions,
  ) => Promise<R>;
}
...
export class RoqClient extends RoqPlatformClient {
  ...
  public operations: OperationsSDK;
  ...
  private initSDK() {
    ...
    this.operations = {
      create: async function createOperations<
        T extends Prisma.operationsCreateArgs,
        R extends CheckSelect<T, operations, Prisma.operationsGetPayload<T>>,
      >(data: Prisma.SelectSubset<T, Prisma.operationsCreateArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/operations/create`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      createMany: async function createManyOperations<
        T extends Prisma.operationsCreateManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.operationsCreateManyArgs>, options?: RequestOptions) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/operations/createMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      update: async function updateOperations<
        T extends Prisma.operationsUpdateArgs,
        R extends Prisma.operationsGetPayload<T>,
      >(data: Prisma.SelectSubset<T, Prisma.operationsUpdateArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/operations/update`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      updateMany: async function updateManyOperations<
        T extends Prisma.operationsUpdateManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.operationsUpdateManyArgs>, options?: RequestOptions) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/operations/updateMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      upsert: async function upsertOperations<
        T extends Prisma.operationsUpsertArgs,
        R extends Prisma.operationsGetPayload<T>,
      >(data: Prisma.SelectSubset<T, Prisma.operationsUpsertArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/operations/upsert`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      delete: async function deleteOperations<
        T extends Prisma.operationsDeleteArgs,
        R extends Prisma.operationsGetPayload<T>,
      >(data: Prisma.SelectSubset<T, Prisma.operationsDeleteArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/operations/delete`;
        const reqUrl = makeUrl(url, data);
        const response = await fetcher<R, true>(
          reqUrl,
          {
      ...
      deleteMany: async function deleteManyOperations<
        T extends Prisma.operationsDeleteManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.operationsDeleteManyArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/operations/deleteMany`;
        const reqUrl = makeUrl(url, data);
        const response = await fetcher<R, false>(
          reqUrl,
          {
      ...
      findMany: async function findManyOperations<
        T extends Prisma.operationsFindManyArgs,
        R extends GetFindResult<Prisma.$operationsPayload<DefaultArgs>, T>[],
      >(args: Prisma.SelectSubset<T, Prisma.operationsFindManyArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/operations/findMany`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
      ...
      count: async function countOperations<T extends Prisma.operationsCountArgs, R extends number>(
        args: Prisma.SelectSubset<T, Prisma.operationsCountArgs>,
        options?: RequestOptions,
      ) {
        const url = `${ctx.endpoint}/api/model/operations/count`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
      ...
      findManyWithCount: async function findManyWithCountOperations<
        T extends Prisma.operationsFindManyArgs,
        R extends GetFindResult<Prisma.$operationsPayload<DefaultArgs>, T>[],
        C extends number,
      >(args: Prisma.SelectSubset<T, Prisma.operationsFindManyArgs>, options?: RequestOptions) {
        const { distinct, orderBy, where } = args || {};
        const [data, count] = await Promise.all([
          ctx.operations.findMany(args, options),
      ...
      findFirst: async function findFirstOperations<
        T extends Prisma.operationsFindFirstArgs,
        R extends GetFindResult<Prisma.$operationsPayload<DefaultArgs>, T>,
      >(args?: Prisma.SelectSubset<T, Prisma.operationsFindFirstArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/operations/findFirst`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
